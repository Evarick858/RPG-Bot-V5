...
globalThis.spackname = "RPG Bot"; // Ganti Sesuai Keinginan
globalThis.sauthor = "Adventure Awaits!\nBot: 0856-2497-5232"; // Ganti Sesuai Keinginan

// Custom Prefix
globalThis.prefix = ["#", ".", "!", "/"]; // Multi Prefix (Custom Prefix)
globalThis.noprefix = true; // True = Tanpa Prefix, False = Pakai Prefix

// Custom Menu Image
globalThis.MenuImage = path.join(__dirname, "./database/image/evarick.jpeg");
...
globalThis.mess = {
  ...
  disable: "🚫 Fitur Ini Sedang Dinonaktifkan Oleh Evarick.",
